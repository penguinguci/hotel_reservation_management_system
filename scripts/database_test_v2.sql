...
INSERT INTO orders (order_id, number_of_nights, order_date, paymentMethod, status, total_price, customer_id, room_id, staff_id)
VALUES
    ('ORD006', 1, '2024-01-06 09:00:00', 'CASH', 1, 1800000, 'C001', 'R101', 'ST001'),
    ('ORD007', 2, '2024-01-07 12:00:00', 'E_WALLET', 1, 2200000, 'C002', 'R102', 'ST002'),
    ('ORD008', 3, '2024-01-08 14:30:00', 'CASH', 1, 4500000, 'C003', 'R201', 'ST003'),
    ('ORD009', 1, '2024-01-09 17:00:00', 'E_WALLET', 1, 1300000, 'C004', 'R202', 'ST001'),
    ('ORD010', 2, '2024-01-10 08:30:00', 'CASH', 1, 2100000, 'C005', 'R301', 'ST002'),

    ('ORD011', 2, '2024-02-01 14:30:00', 'CASH', 1, 1600000, 'C001', 'R101', 'ST002'),
    ('ORD012', 1, '2024-02-02 15:45:00', 'E_WALLET', 1, 1200000, 'C002', 'R102', 'ST003'),
    ('ORD013', 3, '2024-02-03 10:15:00', 'CASH', 1, 6000000, 'C003', 'R201', 'ST002'),
    ('ORD014', 2, '2024-02-04 16:20:00', 'E_WALLET', 1, 3000000, 'C004', 'R202', 'ST003'),
    ('ORD015', 1, '2024-02-05 11:30:00', 'CASH', 1, 2500000, 'C005', 'R301', 'ST002'),
    ('ORD016', 1, '2024-02-06 09:00:00', 'CASH', 1, 1800000, 'C001', 'R101', 'ST001'),
    ('ORD017', 2, '2024-02-07 12:00:00', 'E_WALLET', 1, 2200000, 'C002', 'R102', 'ST002'),
    ('ORD018', 3, '2024-02-08 14:30:00', 'CASH', 1, 4500000, 'C003', 'R201', 'ST003'),
    ('ORD019', 1, '2024-02-09 17:00:00', 'E_WALLET', 1, 1300000, 'C004', 'R202', 'ST001'),
    ('ORD020', 2, '2024-02-10 08:30:00', 'CASH', 1, 2100000, 'C005', 'R301', 'ST002'),

    ('ORD021', 2, '2025-01-01 14:30:00', 'CASH', 1, 1600000, 'C001', 'R101', 'ST002'),
    ('ORD022', 1, '2025-01-02 15:45:00', 'E_WALLET', 1, 1200000, 'C002', 'R102', 'ST003'),
    ('ORD023', 3, '2025-01-03 10:15:00', 'CASH', 1, 6000000, 'C003', 'R201', 'ST002'),
    ('ORD024', 2, '2025-01-04 16:20:00', 'E_WALLET', 1, 3000000, 'C004', 'R202', 'ST003'),
    ('ORD025', 1, '2025-01-05 11:30:00', 'CASH', 1, 2500000, 'C005', 'R301', 'ST002'),
    ('ORD026', 1, '2025-01-06 09:00:00', 'CASH', 1, 1800000, 'C001', 'R101', 'ST001'),
    ('ORD027', 2, '2025-01-07 12:00:00', 'E_WALLET', 1, 2200000, 'C002', 'R102', 'ST002'),
    ('ORD028', 3, '2025-01-08 14:30:00', 'CASH', 1, 4500000, 'C003', 'R201', 'ST003'),
    ('ORD029', 1, '2025-01-09 17:00:00', 'E_WALLET', 1, 1300000, 'C004', 'R202', 'ST001'),
    ('ORD030', 2, '2025-01-10 08:30:00', 'CASH', 1, 2100000, 'C005', 'R301', 'ST002'),

    ('ORD031', 2, '2025-02-01 14:30:00', 'CASH', 1, 1600000, 'C001', 'R101', 'ST002'),
    ('ORD032', 1, '2025-02-02 15:45:00', 'E_WALLET', 1, 1200000, 'C002', 'R102', 'ST003'),
    ('ORD033', 3, '2025-02-03 10:15:00', 'CASH', 1, 6000000, 'C003', 'R201', 'ST002'),
    ('ORD034', 2, '2025-02-04 16:20:00', 'E_WALLET', 1, 3000000, 'C004', 'R202', 'ST003'),
    ('ORD035', 1, '2025-02-05 11:30:00', 'CASH', 1, 2500000, 'C005', 'R301', 'ST002'),
    ('ORD036', 1, '2025-02-06 09:00:00', 'CASH', 1, 1800000, 'C001', 'R101', 'ST001'),
    ('ORD037', 2, '2025-02-07 12:00:00', 'E_WALLET', 1, 2200000, 'C002', 'R102', 'ST002'),
    ('ORD038', 3, '2025-02-08 14:30:00', 'CASH', 1, 4500000, 'C003', 'R201', 'ST003'),
    ('ORD039', 1, '2025-02-09 17:00:00', 'E_WALLET', 1, 1300000, 'C004', 'R202', 'ST001'),
    ('ORD040', 2, '2025-02-10 08:30:00', 'CASH', 1, 2100000, 'C005', 'R301', 'ST002');
